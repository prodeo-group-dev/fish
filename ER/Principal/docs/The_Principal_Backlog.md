...
| BK-PLT-8 | Real institution↔School linkage (EA auto-provisioning) | M | **Done, both sides, 2026-09-23** — SchoolAdmissions (`fish-school-admissions` `57ad955`) and EA (`fish-enterprise-administration` `4243574`), verified together end to end against real production Cognito + a real `POST /schools` call (temporary diagnostic route, added/removed same day). Design: `docs/SchoolAdmissions_Institution_Linkage_And_Guardian_Billing_Design.md`. One cleanup item: a real "EA Verification Test - DELETE ME" School row (`ee7fc00d-7375-4538-98f9-3444cdde2dd1`) needs manual DB removal - no `DELETE /schools` route exists. Replaces WEB's Student Management Console manual-paste-School-ID stopgap. Unblocked Guardian-as-Customer, built same day - see BK-FEE row below. |
